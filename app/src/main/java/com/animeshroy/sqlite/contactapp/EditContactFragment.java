...
import com.animeshroy.sqlite.contactapp.Utils.ChangePhotoDialog;
import com.animeshroy.sqlite.contactapp.Utils.DatabaseHelper;
import com.animeshroy.sqlite.contactapp.Utils.Init;
...
public class EditContactFragment extends Fragment implements ChangePhotoDialog.OnPhotoReceivedListener{
    ...
    private ImageView editContactFragmentDelete;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        editContactFragmentDelete = view.findViewById(R.id.editContactFragmentDelete);
        ...
        editContactFragmentDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                delete();
            }
