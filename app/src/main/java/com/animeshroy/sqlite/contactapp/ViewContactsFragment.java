...
import com.animeshroy.sqlite.contactapp.Utils.ContactListAdapter;
...
//        contacts.add(new Contact("Mitch Tabian", "(604) 855-1111", "Mobile","mitch@tabian.ca", testImageURL));
        ...
        adapter = new ContactListAdapter(getActivity(), R.layout.layout_contacts_listitem, contacts, "");
        ...
        contactsList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Log.d(TAG, "onClick: navigating to " + getString(R.string.view_contact_fragment));
